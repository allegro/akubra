...
func initConfig() {
	...
	cfg := config.CredentialsStoreMap{
		"default": config.CredentialsStore{Endpoint: types.YAMLUrl{URL: mockURL}, TTL: 10},
		"invalid": config.CredentialsStore{Endpoint: types.YAMLUrl{URL: invalidURL}, TTL: 10},
	}
